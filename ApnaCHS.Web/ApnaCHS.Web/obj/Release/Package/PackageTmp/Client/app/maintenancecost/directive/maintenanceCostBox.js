app.directive('maintenanceCostBox', ['$http', 'DATA_URLS', '$location', '$anchorScroll', '$filter', '$stateParams', '$rootScope', 'appConstant', 'localStorageService', '$window', 'authService',
    function ($http, DATA_URLS, $location, $anchorScroll, $filter, $stateParams, $rootScope, appConstant, localStorageService, $window, authService) {
        'use strict';
