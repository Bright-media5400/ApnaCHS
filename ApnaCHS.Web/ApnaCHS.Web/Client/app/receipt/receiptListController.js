app.controller('receiptListController', ['$scope', 'authService', '$rootScope', '$window', '$location', 'DATA_URLS'
    , '$http', '$filter', 'appConstant', '$routeParams','localStorageService', 'societyService',
function ($scope, authService, $rootScope, $window, $location, DATA_URLS, $http, $filter, appConstant, $routeParams, localStorageService, societyService) {
