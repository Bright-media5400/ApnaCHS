app.controller('complexListController', ['$scope', 'authService', '$rootScope', '$window', '$location', 'DATA_URLS'
    , '$http', '$filter', 'appConstant', 'localStorageService', 'societyService',
function ($scope, authService, $rootScope, $window, $location, DATA_URLS, $http, $filter, appConstant, localStorageService, societyService) {
