app.directive('flatownerDetailsBox', ['$http', 'DATA_URLS', '$window', '$location', '$anchorScroll', '$filter', '$stateParams', '$rootScope', 'appConstant', 'localStorageService', '$timeout', 'societyService',
    function ($http, DATA_URLS, $window, $location, $anchorScroll, $filter, $stateParams, $rootScope, appConstant, localStorageService, $timeout, societyService) {
        'use strict';
