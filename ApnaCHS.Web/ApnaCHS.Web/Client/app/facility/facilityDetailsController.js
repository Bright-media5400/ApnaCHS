app.controller('facilityDetailsController', [
    '$scope', '$rootScope', '$window', '$location', '$http', '$routeParams', '$anchorScroll', '$filter', 'DATA_URLS', 'appConstant', 'localStorageService', 'societyService',
function ($scope, $rootScope, $window, $location, $http, $routeParams, $anchorScroll, $filter, DATA_URLS, appConstant, localStorageService, societyService) {
        ...
        promise.then(function (data) {
            if (!data.status || data.status == 200) {
                ...
                if ($scope.editFormData.type == 1) {
                    ...
                    societyService.setSociety(sdata);
                }
