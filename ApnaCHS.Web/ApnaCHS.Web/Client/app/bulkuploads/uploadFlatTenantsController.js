app.controller('uploadFlatTenantsController', [
...
function ($scope, $rootScope, $window, $location, $http, $routeParams, $anchorScroll, $filter, DATA_URLS, appConstant, localStorageService, $sce, societyService) {
    ...
    $scope.downloadExcel = function () {
        ...
        data2xlsx({
            filename: "Flat Tenants History Template" + ".xlsx",
            sheetName: "FlatTenants",
            data: toexport
        });
    ...
    $scope.save = function () {
        ...
        var promise = $http.post(DATA_URLS.UPLOAD_TENANTS, fdata);
        promise.then(function (data) {
    ...
    $scope.onAllExportResult = function () {
        ...
        data2xlsx({
            filename: "Flat Tenants All Export Result" + ".xlsx",
            sheetName: "All",
            data: toexport
        });
    ...
    $scope.onFailedExportResult = function () {
        ...
        data2xlsx({
            filename: "Flat Tenats Failed Export Result" + ".xlsx",
            sheetName: "Failed",
            data: toexport
        });
    }
